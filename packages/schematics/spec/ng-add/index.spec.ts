...
describe('Serenity/JS Schematic', () => {
    describe('add', () => {
        ...
        it('updates the e2e directory in the angular workspace', async () => {
            ...
            expect(workspace.schematics['@serenity-js/schematics:question'].directory).to.exist;
            expect(workspace.schematics['@serenity-js/schematics:question'].directory).to.equal('features');
        });
    });
});
